...
class HeatIdentifier(collections.Mapping):
    ...
    def from_arn(cls, arn):
        ...
        if fields[1] != 'openstack' or fields[2] != 'rushstack' or not path:
    ...
    def from_arn_url(cls, url):
        ...
        arn_url_prefix = '/arn%3Aopenstack%3Arushstack%3A%3A'
    ...
    def arn(self):
        ...
        Return an ARN of the form:
            arn:openstack:rushstack::<tenant>:stacks/<stack_name>/<stack_id><path>
        '''
        return 'arn:openstack:rushstack::%s:%s' % (urllib.quote(self.tenant, ''),
                                              self._tenant_path())
